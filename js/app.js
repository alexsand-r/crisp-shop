(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".most-item__slider")) new core(".most-item__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                spaceBetween: 0,
            ...
            if (document.querySelector(".featured-item__slider")) new core(".featured-item__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                spaceBetween: 0,
            ...
            if (document.querySelector(".product__image")) {
                let thumbsSwiper = new core(".image-prewiev__slider", {
                ...
                new core(".image-product__slider", {
                    modules: [ Navigation, Thumb, Controller, EffectFade, Zoom, Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    spaceBetween: 20,
        ...
        if (document.querySelector(".spollers-range")) {
            const priceSlider = document.getElementById("price-range");
            const priceInputFrom = document.getElementById("price-range__from");
            const priceInputTo = document.getElementById("price-range__to");
            ...
            priceSlider.noUiSlider.on("update", (function(values, handle) {
                ...
                if (0 === handle) priceInputFrom.value = value; else priceInputTo.value = value;
            }));
